        ...
        <section>
          <div className="mb-6 flex flex-col gap-1">
            ...
            <p className="text-muted-foreground text-sm">
              Withdraw accumulated marketplace royalties (10% of every paid clone, floor 0.05 SUI).
              Only the wallet holding the <code className="font-mono">PlatformAdminCap</code> can
              sign.
            </p>
          </div>
