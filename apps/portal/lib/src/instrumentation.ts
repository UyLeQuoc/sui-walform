...
export class InstrumentationFacade {
  ...
  constructor(port: number) {
    ...
    this.num_generic_errors_counter = this.meter.createCounter('ws_num_generic_errors_counter', {
    ...
    this.num_aggregator_fail_counter = this.meter.createCounter('ws_num_aggregator_fail_counter', {
  ...
  public recordAggregatorTime(time: number, siteId: string) {
    this.aggregatorTime.record(time, { siteId });
  }
