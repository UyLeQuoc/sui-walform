...
const redirectToAggregatorUrlTestCases: [string, string, string][] = [
  ['https://example.com', '12345', 'https://aggregator.walrus-testnet.walrus.space/v1/blobs/12345'],
  ['https://wal.app', 'blob-id', 'https://aggregator.walrus-testnet.walrus.space/v1/blobs/blob-id'],
  [
    'http://localhost:8080',
    'abcde',
