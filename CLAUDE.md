...
- **Seal** encrypts submission bodies + form schemas client-side, via Mysten's decentralized **committee** key servers behind a hosted aggregator (testnet 3-of-5, keyless; mainnet 5-of-8, **requires an Enoki-issued key sent as `X-API-Key`**).
