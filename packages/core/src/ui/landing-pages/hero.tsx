      ...
      >
        ...
        >
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="border-border/80 bg-background/70 text-muted-foreground hover:text-foreground inline-flex h-9 items-center gap-2 border px-3 text-xs font-medium shadow-sm backdrop-blur transition-colors"
          >
