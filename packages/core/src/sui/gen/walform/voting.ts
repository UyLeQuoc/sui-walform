...
export const TemplateVotes = new MoveStruct({
  name: `${$moduleName}::TemplateVotes`,
  fields: {
    id: bcs.Address,
...
export const VoteRecord = new MoveStruct({
  name: `${$moduleName}::VoteRecord`,
  fields: {
    value: bcs.u8(),
  },
});
export const TemplateVotesInitialized = new MoveStruct({
  name: `${$moduleName}::TemplateVotesInitialized`,
  fields: {
    template_id: bcs.Address,
...
export interface InitTemplateVotesOptions {
  package?: string;
  arguments: InitTemplateVotesArguments | [template: RawTransactionArgument<string>];
}
/**
...
export interface UpvoteOptions {
  package?: string;
  arguments: UpvoteArguments | [votes: RawTransactionArgument<string>];
}
...
export interface DownvoteOptions {
  package?: string;
  arguments: DownvoteArguments | [votes: RawTransactionArgument<string>];
}
...
export interface ClearVoteOptions {
  package?: string;
  arguments: ClearVoteArguments | [votes: RawTransactionArgument<string>];
}
...
export interface TemplateIdOptions {
  package?: string;
  arguments: TemplateIdArguments | [v: RawTransactionArgument<string>];
}
...
export interface UpvotesOptions {
  package?: string;
  arguments: UpvotesArguments | [v: RawTransactionArgument<string>];
}
...
export interface DownvotesOptions {
  package?: string;
  arguments: DownvotesArguments | [v: RawTransactionArgument<string>];
}
...
export interface VoteOfOptions {
  ...
  arguments:
    | VoteOfArguments
    | [v: RawTransactionArgument<string>, voter: RawTransactionArgument<string>];
}
