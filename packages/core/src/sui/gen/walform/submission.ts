...
export const Submission = new MoveStruct({
  name: `${$moduleName}::Submission`,
  fields: {
    id: bcs.Address,
    form_id: bcs.Address,
...
export interface ShareOptions {
  package?: string;
  arguments: ShareArguments | [s: RawTransactionArgument<string>];
}
/**
...
export interface FormIdOptions {
  package?: string;
  arguments: FormIdArguments | [s: RawTransactionArgument<string>];
}
...
export interface SubmitterOptions {
  package?: string;
  arguments: SubmitterArguments | [s: RawTransactionArgument<string>];
}
...
export interface EncryptedBodyOptions {
  package?: string;
  arguments: EncryptedBodyArguments | [s: RawTransactionArgument<string>];
}
...
export interface FileBlobIdsOptions {
  package?: string;
  arguments: FileBlobIdsArguments | [s: RawTransactionArgument<string>];
}
...
export interface NonceOptions {
  package?: string;
  arguments: NonceArguments | [s: RawTransactionArgument<string>];
}
...
export interface SubmittedAtMsOptions {
  package?: string;
  arguments: SubmittedAtMsArguments | [s: RawTransactionArgument<string>];
}
