...
export const FormSettings = new MoveStruct({
  name: `${$moduleName}::FormSettings`,
  fields: {
    access_mode: bcs.u8(),
...
export const FormStats = new MoveStruct({
  name: `${$moduleName}::FormStats`,
  fields: {
...
export interface ShareOptions {
  package?: string;
  arguments: ShareArguments | [form: RawTransactionArgument<string>];
}
/**
...
export interface IdAddressOptions {
  package?: string;
  arguments: IdAddressArguments | [form: RawTransactionArgument<string>];
}
/**
...
export interface OwnerOptions {
  package?: string;
  arguments: OwnerArguments | [form: RawTransactionArgument<string>];
}
...
export interface SchemaOptions {
  package?: string;
  arguments: SchemaArguments | [form: RawTransactionArgument<string>];
}
...
export interface ThemeOptions {
  package?: string;
  arguments: ThemeArguments | [form: RawTransactionArgument<string>];
}
...
export interface SiteObjectIdOptions {
  package?: string;
  arguments: SiteObjectIdArguments | [form: RawTransactionArgument<string>];
}
...
export interface CoverBlobIdOptions {
  package?: string;
  arguments: CoverBlobIdArguments | [form: RawTransactionArgument<string>];
}
...
export interface SettingsOptions {
  package?: string;
  arguments: SettingsArguments | [form: RawTransactionArgument<string>];
}
...
export interface StatsOptions {
  package?: string;
  arguments: StatsArguments | [form: RawTransactionArgument<string>];
}
...
export interface ClosedOptions {
  package?: string;
  arguments: ClosedArguments | [form: RawTransactionArgument<string>];
}
...
export interface AccessModeOptions {
  package?: string;
  arguments: AccessModeArguments | [s: TransactionArgument];
}
...
export interface AllowlistIdOptions {
  package?: string;
  arguments: AllowlistIdArguments | [s: TransactionArgument];
}
...
export interface SubmissionFeeMistOptions {
  package?: string;
  arguments: SubmissionFeeMistArguments | [s: TransactionArgument];
}
...
export interface MaxSubmissionsOptions {
  package?: string;
  arguments: MaxSubmissionsArguments | [s: TransactionArgument];
}
...
export interface ClosesAtMsOptions {
  package?: string;
  arguments: ClosesAtMsArguments | [s: TransactionArgument];
}
...
export interface RequiredTokenTypeOptions {
  package?: string;
  arguments: RequiredTokenTypeArguments | [s: TransactionArgument];
}
...
export interface RequiredTokenAmountOptions {
  package?: string;
  arguments: RequiredTokenAmountArguments | [s: TransactionArgument];
}
...
export interface SubmissionCountOptions {
  package?: string;
  arguments: SubmissionCountArguments | [s: TransactionArgument];
}
...
export interface TotalRevenueMistOptions {
  package?: string;
  arguments: TotalRevenueMistArguments | [s: TransactionArgument];
}
