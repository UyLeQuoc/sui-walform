...
export const FormReviewers = new MoveStruct({
  name: `${$moduleName}::FormReviewers`,
  fields: {
    id: bcs.Address,
    form_id: bcs.Address,
    /**
...
export const ReviewersCreated = new MoveStruct({
  name: `${$moduleName}::ReviewersCreated`,
  fields: {
    form_id: bcs.Address,
...
export const ReviewerAdded = new MoveStruct({
  name: `${$moduleName}::ReviewerAdded`,
  fields: {
    form_id: bcs.Address,
    reviewers_id: bcs.Address,
    by: bcs.Address,
...
export const ReviewerRemoved = new MoveStruct({
  name: `${$moduleName}::ReviewerRemoved`,
  fields: {
    form_id: bcs.Address,
    reviewers_id: bcs.Address,
    by: bcs.Address,
...
export interface CreateAndShareOptions {
  ...
  arguments:
    ...
    | [cap: RawTransactionArgument<string>, form: RawTransactionArgument<string>];
}
/**
...
export interface AddReviewerOptions {
  package?: string;
  arguments:
    | AddReviewerArguments
    | [reviewers: RawTransactionArgument<string>, newMember: RawTransactionArgument<string>];
}
/**
...
export interface FormIdOptions {
  package?: string;
  arguments: FormIdArguments | [r: RawTransactionArgument<string>];
}
...
export interface OwnerOptions {
  package?: string;
  arguments: OwnerArguments | [r: RawTransactionArgument<string>];
}
...
export interface MembersOptions {
  package?: string;
  arguments: MembersArguments | [r: RawTransactionArgument<string>];
}
...
export interface IsReviewerOptions {
  ...
  arguments:
    | IsReviewerArguments
    | [r: RawTransactionArgument<string>, who: RawTransactionArgument<string>];
}
...
export interface MemberCountOptions {
  package?: string;
  arguments: MemberCountArguments | [r: RawTransactionArgument<string>];
}
