...
export const TEMPLATE = new MoveStruct({
  name: `${$moduleName}::TEMPLATE`,
  fields: {
    dummy_field: bcs.bool(),
  },
});
export const RoyaltyRule = new MoveStruct({
  name: `${$moduleName}::RoyaltyRule`,
  fields: {
    dummy_field: bcs.bool(),
  },
});
export const RoyaltyConfig = new MoveStruct({
  name: `${$moduleName}::RoyaltyConfig`,
  fields: {
    bps: bcs.u16(),
    min_amount_mist: bcs.u64(),
  },
});
export const FormTemplate = new MoveStruct({
  name: `${$moduleName}::FormTemplate`,
  fields: {
    id: bcs.Address,
    creator: bcs.Address,
    title: bcs.string(),
...
export const PlatformTreasury = new MoveStruct({
  name: `${$moduleName}::PlatformTreasury`,
  fields: {
    id: bcs.Address,
    balance: balance.Balance,
  },
});
export const PlatformAdminCap = new MoveStruct({
  name: `${$moduleName}::PlatformAdminCap`,
  fields: {
    id: bcs.Address,
  },
});
export const TemplateListing = new MoveStruct({
  name: `${$moduleName}::TemplateListing`,
  fields: {
    id: bcs.Address,
...
/**
 * Place an already-minted FormTemplate into a kiosk and list it at the given
 * price. Two-step so the caller retains control of the template id (returned by
 * `publish_template`).
 */
...
export interface CreateListingAndShareOptions {
  package?: string;
  arguments:
    | CreateListingAndShareArguments
    | [
        template: RawTransactionArgument<string>,
        priceMist: RawTransactionArgument<number | bigint>,
      ];
...
export interface ListingTemplateIdOptions {
  package?: string;
  arguments: ListingTemplateIdArguments | [l: RawTransactionArgument<string>];
}
...
export interface ListingCreatorOptions {
  package?: string;
  arguments: ListingCreatorArguments | [l: RawTransactionArgument<string>];
}
...
export interface ListingPriceMistOptions {
  package?: string;
  arguments: ListingPriceMistArguments | [l: RawTransactionArgument<string>];
}
 ...
 *
 * 1.  kiosk::purchase — pays the listed price, gets the template and a
 *     TransferRequest.
 * 2.  royalty payment — deposits 10% (or the floor) into PlatformTreasury, adds
 *     receipt.
 ...
 *     The buyer is expected to then `transfer::share_object(form)` and transfer
 *     the cap or use `purchase_template_and_share` below.
 */
...
export interface PurchaseTemplateAndShareOptions {
  package?: string;
  arguments:
    | PurchaseTemplateAndShareArguments
    | [
        sellerKiosk: RawTransactionArgument<string>,
        templateId: RawTransactionArgument<string>,
        policy: RawTransactionArgument<string>,
...
export interface IdAddressOptions {
  package?: string;
  arguments: IdAddressArguments | [t: RawTransactionArgument<string>];
}
...
export interface CreatorOptions {
  package?: string;
  arguments: CreatorArguments | [t: RawTransactionArgument<string>];
}
...
export interface TitleOptions {
  package?: string;
  arguments: TitleArguments | [t: RawTransactionArgument<string>];
}
...
export interface DescriptionOptions {
  package?: string;
  arguments: DescriptionArguments | [t: RawTransactionArgument<string>];
}
...
export interface CategoryOptions {
  package?: string;
  arguments: CategoryArguments | [t: RawTransactionArgument<string>];
}
...
export interface SchemaOptions {
  package?: string;
  arguments: SchemaArguments | [t: RawTransactionArgument<string>];
}
...
export interface ThemeOptions {
  package?: string;
  arguments: ThemeArguments | [t: RawTransactionArgument<string>];
}
...
export interface TagsOptions {
  package?: string;
  arguments: TagsArguments | [t: RawTransactionArgument<string>];
}
...
export interface CloneCountOptions {
  package?: string;
  arguments: CloneCountArguments | [t: RawTransactionArgument<string>];
}
...
export interface PlatformBalanceOptions {
  package?: string;
  arguments: PlatformBalanceArguments | [t: RawTransactionArgument<string>];
}
